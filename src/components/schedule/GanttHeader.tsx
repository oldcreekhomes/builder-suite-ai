  ...
  return (
    <TableHeader>
      <TableRow className="h-8 bg-slate-50 border-b border-slate-200">
        ...
        <TableHead className="py-2 text-xs font-bold text-slate-700 min-w-[120px] pr-1">Name</TableHead>
        <TableHead className="py-2 text-xs font-bold text-slate-700 w-20 pl-1">Start Date</TableHead>
