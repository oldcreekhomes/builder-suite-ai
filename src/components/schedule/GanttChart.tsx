...
export const GanttChart: React.FC<GanttChartProps> = ({ projectId }) => {
  ...
  // ENHANCED: Added WBS field mapping while keeping all existing functionality
  const taskFields = {
    id: 'TaskID',
    name: 'TaskName',
    startDate: 'StartDate',
  ...
  // 🎉 ENHANCED COLUMNS: Added WBS column while keeping all existing columns
  const columns = [
    { 
      field: 'WBS', 
      headerText: 'WBS Code', 
      width: 100, 
      allowEditing: false // WBS codes should be auto-generated, not manually edited
    },
  ...
  const splitterSettings = {
    columnIndex: 4 // Adjusted to account for WBS column
  };
