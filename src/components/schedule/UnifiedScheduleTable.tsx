      ...
      <Table containerClassName="relative w-full">
        <TableHeader className="z-50">
          <TableRow className="h-8">
            ...
            <TableHead className="sticky left-0 z-50 bg-background w-10 h-8 text-xs py-1 px-2 border-r">
              <Checkbox
            ...
            <TableHead className="sticky left-10 z-50 bg-background w-16 h-8 text-xs py-1 pl-4 pr-4 border-r">#</TableHead>
            <TableHead className="sticky z-50 bg-background w-48 h-8 text-xs py-1 px-2 border-r" style={{ left: '104px' }}>Task Name</TableHead>
            <TableHead className="sticky z-50 bg-background w-24 h-8 text-xs py-1 px-2 border-r whitespace-nowrap" style={{ left: '296px' }}>Start Date</TableHead>
            <TableHead className="sticky z-50 bg-background w-20 h-8 text-xs py-1 px-2 border-r" style={{ left: '392px' }}>Duration</TableHead>
            <TableHead className="sticky z-50 bg-background w-24 h-8 text-xs py-1 px-2 border-r whitespace-nowrap" style={{ left: '472px' }}>End Date</TableHead>
            <TableHead className="sticky z-50 bg-background w-24 h-8 text-xs py-1 px-2 border-r" style={{ left: '568px' }}>Predecessors</TableHead>
            <TableHead className="sticky z-50 bg-background w-20 h-8 text-xs py-1 px-2 border-r" style={{ left: '664px' }}>Progress</TableHead>
            <TableHead className="sticky z-50 bg-background w-32 h-8 text-xs py-1 px-2 border-r" style={{ left: '744px' }}>Resources</TableHead>
          ...
          {visibleTasks.map((task, index) => {
            ...
            return (
              ...
              >
                ...
                >
                  {/* Selection Checkbox */}
                  <TableCell className="sticky left-0 z-50 bg-background group-hover:bg-background py-1 px-2 w-10 h-8 overflow-hidden border-r">
                    <div
                  ...
                  {/* Hierarchy Number */}
                  <TableCell className="sticky left-10 z-50 bg-background group-hover:bg-background text-xs py-1 pl-4 pr-4 w-16 h-8 border-r">
                    <span className="text-xs">{task.hierarchy_number || "—"}</span>
                  </TableCell>

                  {/* Task Name with Indentation */}
                  <TableCell className="sticky z-50 bg-background group-hover:bg-background py-1 pl-2 pr-2 w-48 h-8 overflow-hidden border-r" style={{ left: '104px' }}>
                  ...
                  {/* Start Date */}
                  <TableCell className="sticky z-50 bg-background group-hover:bg-background py-1 px-2 w-24 h-8 overflow-hidden border-r" style={{ left: '296px' }}>
                    <InlineEditCell
                      value={(() => {
                        try {
                  ...
                  {/* Duration */}
                  <TableCell className="sticky z-50 bg-background group-hover:bg-background py-1 px-2 w-20 h-8 overflow-hidden border-r" style={{ left: '392px' }}>
                    <InlineEditCell
                  ...
                  <TableCell 
                    className={`sticky z-50 py-1 px-2 w-24 h-8 overflow-hidden border-r ${
                      isTaskOverdue(task.end_date, task.progress) ? "bg-red-500 group-hover:bg-red-500" : "bg-background group-hover:bg-background"
                    }`}
                    style={{ left: '472px' }}
                  >
                    <InlineEditCell
                  ...
                  {/* Predecessors */}
                  <TableCell className="sticky z-50 bg-background group-hover:bg-background py-1 px-2 w-24 h-8 overflow-hidden border-r" style={{ left: '568px' }}>
                    <PredecessorSelector
                  ...
                  {/* Progress */}
                  <TableCell className="sticky z-50 bg-background group-hover:bg-background py-1 px-2 w-20 h-8 overflow-hidden border-r" style={{ left: '664px' }}>
                    <ProgressSelector
                  ...
                  {/* Resources */}
                  <TableCell className="sticky z-50 bg-background group-hover:bg-background py-1 px-2 w-32 h-8 overflow-hidden border-r" style={{ left: '744px' }}>
                    <ResourcesSelector
...
className={`absolute top-0 h-full border-r border-border/30 ${
                              isWeekend ? "bg-blue-50" : "bg-background"
                            }`}
                              style={{ left: i * dayWidth, width: dayWidth }}
                            />
                          );
