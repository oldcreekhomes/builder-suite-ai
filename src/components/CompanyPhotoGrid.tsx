...
interface CompanyPhotoGridProps {
  photos: AllPhoto[];
  onPhotoSelect: (photo: AllPhoto) => void;
  onRefresh: () => void;
}

export function CompanyPhotoGrid({ photos, onPhotoSelect, onRefresh }: CompanyPhotoGridProps) {
    ...
    return (
      <Card className="p-12 text-center">
        <div className="text-gray-500">
          ...
          <p>Photos from your projects will appear here</p>
        </div>
      </Card>
    );
  }
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  This action cannot be undone. This will permanently delete the selected photos from your projects.
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
