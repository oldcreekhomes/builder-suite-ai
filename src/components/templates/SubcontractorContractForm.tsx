...
K. Asphalt and Paving
  ...
  const handlePrint = useCallback(() => {
    ...
    const htmlContent = [
      ...
      `  body { margin: 0; }`,
      `  .print-footer { position: fixed; bottom: 0; left: 0; right: 0; display: flex; justify-content: space-between; align-items: center; font-size: 8px; color: #000; padding: 4px 0; }`,
      `  .print-footer .page-num::after { content: "Page " counter(page); }`,
      `}`,
      `@media screen { body { margin: 0.5in; } }`,
      `.page-content { padding: 0 0 0.4in 0; box-sizing: border-box; }`,
