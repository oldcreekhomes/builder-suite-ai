...
interface AddMarketplaceRepresentativeDialogProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
}

export function AddMarketplaceRepresentativeDialog({ open, onOpenChange }: AddMarketplaceRepresentativeDialogProps) {
  ...
  const createRepresentativeMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast({
        title: "Success",
        description: "Marketplace representative added successfully",
      });
      form.reset();
      onOpenChange(false);
    },
    onError: (error) => {
      console.error('Error creating marketplace representative:', error);
      toast({
        title: "Error",
        description: "Failed to add marketplace representative",
        variant: "destructive",
      });
    },
  });
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md">
        <DialogHeader>
          <DialogTitle>Add Marketplace Representative</DialogTitle>
        </DialogHeader>
