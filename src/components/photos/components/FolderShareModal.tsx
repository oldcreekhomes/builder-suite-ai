  ...
  const generateShareLink = async () => {
    ...
    try {
      ...
      if (!existingError && existingShare) {
        ...
        const shareUrl = `${baseUrl}?id=${existingShare.share_id}&type=p`;
      ...
      const link = `https://nlmnwlvmmkngrgatnzkj.supabase.co/functions/v1/share-redirect?id=${shareId}&type=p`;
      setShareLink(link);
