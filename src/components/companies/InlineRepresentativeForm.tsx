...
export interface InlineRepresentativeFormRef {
  validate: () => Promise<boolean>;
  getValues: () => InlineRepresentativeData;
  reset: () => void;
}

export const InlineRepresentativeForm = forwardRef<InlineRepresentativeFormRef>(
  (_, ref) => {
...
InlineRepresentativeForm.displayName = "InlineRepresentativeForm";
