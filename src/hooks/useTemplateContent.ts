...
export const DEFAULT_ARTICLES: TemplateArticle[] = [
  ...
  { num: 4, title: "PAYMENTS (PAY-IF-PAID)", body: "Payment to Subcontractor is expressly conditioned upon Contractor receiving payment from the Owner for Subcontractor's Work. Payment by Owner to Contractor for Subcontractor work is a condition precedent to payment to Subcontractor." },
