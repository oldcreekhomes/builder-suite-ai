        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground mb-4 max-w-2xl mx-auto">
              <span className="block">We didn't want to build software—we had to. Every tool out there is built</span>
              <span className="block">by a silicon valley tech engineer who doesn't understand our industry.</span>
            </p>
