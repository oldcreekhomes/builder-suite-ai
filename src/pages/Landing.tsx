      ...
      <section className="py-20 bg-gradient-to-b from-muted/50 to-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground mb-4 mx-auto">
              <span className="block sm:whitespace-nowrap">
                We didn't want to build software—we had to. Every tool out there is built by a silicon valley tech engineer
              </span>
              <span className="block">who doesn't understand our industry.</span>
            </p>
