...
export const GanttChart: React.FC<GanttChartProps> = ({ projectId }) => {
  ...
  // Add state to track drag operations and prevent real-time conflicts
  ...
  // Handle actions - NEW APPROACH: Intercept drag operations before they happen
  const handleActionBegin = (args: any) => {
    if (!args) return;
    
    console.log('🎬 Action begin:', args.requestType);
    console.log('🎬 Action begin - Full args:', args);
      ...
      <div className="control-section">
        <div className="col-lg-12">
          <div className="mb-2 text-sm text-gray-500">
            ...
            {isDragInProgress && <span className="ml-2 text-orange-500">| Drag in progress...</span>}
          </div>
