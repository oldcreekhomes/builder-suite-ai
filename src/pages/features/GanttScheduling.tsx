...
export default function GanttScheduling() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      {/* Hero Section */}
      <section className="w-full py-24 md:py-32 bg-gradient-to-b from-muted/50 to-background">
      ...
      {/* Feature Row 1 - Automated Email Notifications */}
      <FeatureRow
      ...
      {/* Feature Row 2 - One-Click Confirmation */}
      <FeatureRow
      ...
      {/* Feature Row 3 - Color-Coded Status */}
      <FeatureRow
        label="VISUAL STATUS"
      ...
      {/* Feature Row 4 - Project Manager Efficiency */}
      <FeatureRow
        label="PM EFFICIENCY"
      ...
      {/* CTA Section */}
      <section className="w-full py-24 md:py-32 bg-primary">
