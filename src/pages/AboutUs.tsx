    ...
    <div className="min-h-screen w-full bg-background">
          ...
          <div className="max-w-3xl mx-auto">
            <div className="prose prose-lg max-w-none text-center">
              <p className="text-lg md:text-xl text-muted-foreground leading-relaxed mb-6">
                In 2019, Matt Gray started Old Creek Homes, LLC with nothing but Excel spreadsheets, QuickBooks, and $47,000.
              </p>
                ...
                <CardContent className="pt-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">Today, BuilderSuite manages every project at Old Creek Homes. We track tens of millions in budgets, coordinate with hundreds of subcontractors, and process millions of dollars in invoices on a monthly basis. All in the same software we're offering to you.</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
      ...
      <section className="py-20 bg-background">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
              The BuilderSuite Difference
            </h2>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              This isn't theoretical software built by engineers. It's battle-tested every single day.
            </p>
          </div>
