            ...
            {bidPackage && (
              <div className="mb-8">
                ...
                <div className="border border-gray-200 p-4 space-y-2">
                  <div className="flex">
                    <span className="text-gray-600 font-medium w-32">Project Address:</span>
                  ...
                  {bidPackage.due_date && (
                    <div className="flex">
                      <span className="text-gray-600 font-medium w-32">Bid Due Date:</span>
                  ...
                  {company && (
                    <div className="flex">
                      <span className="text-gray-600 font-medium w-32">Your Company:</span>
