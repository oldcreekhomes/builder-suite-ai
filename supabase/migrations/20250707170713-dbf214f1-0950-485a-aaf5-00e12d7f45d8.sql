-- Remove redundant role field from home_builders table
-- since all records in this table are company owners by definition

ALTER TABLE public.home_builders 
DROP COLUMN IF EXISTS role;

-- Update the handle_new_user function accordingly
