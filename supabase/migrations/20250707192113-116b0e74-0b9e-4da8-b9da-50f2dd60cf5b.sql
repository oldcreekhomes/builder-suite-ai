...
-- Step 2: Update existing employee records in home_builders with employee-specific data
...
-- Step 3: Set default role for home builders
UPDATE public.home_builders 
SET role = 'admin' 
WHERE user_type = 'home_builder' AND role = 'employee';
