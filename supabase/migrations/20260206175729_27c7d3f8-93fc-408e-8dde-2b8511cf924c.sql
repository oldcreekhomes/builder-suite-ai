-- Fix approve_pending_bill to include lot_id when copying lines to bill_lines
...
BEGIN
  ...
  LOOP
    INSERT INTO bill_lines (
      ...
      COALESCE(line_record.project_id, project_id_param),
      line_record.lot_id,
  ...
  -- Mark pending upload as approved with review notes
